...
static QPoint sg_wheelAngleDelta;
...
QPoint Input::wheelDelta()
{
	return sg_wheelAngleDelta;
}
...
void Input::registerWheelEvent(QWheelEvent *event)
{
	sg_wheelAngleDelta = event->angleDelta();
}
